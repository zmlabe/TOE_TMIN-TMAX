"""
Function(s) reads in monthly data from SPEAR_MED_LM42p2 for different variables 
...
Usage
-----
    [1] read_SPEAR_MED_LM42p2(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
"""

def read_SPEAR_MED_LM42p2(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper):
    """
    Function reads monthly data from SPEAR_MED_LM42p2
    ...
    Usage
    -----
    read_SPEAR_MED_LM42p2(directory,vari,sliceperiod,sliceshape,
                             slicenan,numOfEns,timeper)
    """
    print('\n>>>>>>>>>> STARTING read_SPEAR_MED_LM42p2 function!')
    ...
    for i,ensmember in enumerate(ens):
        ...
        print('Completed: read *SPEAR_MED_LM42p2* Ensemble Member --%s-- for %s' % (ensmember,vari))
    ...
    print('Completed: read all SPEAR_MED_LM42p2 Members!\n')
    ...
    print('>>>>>>>>>> ENDING read_SPEAR_MED_LM42p2 function!')    
...
# numOfEns = 3
# timeper = 'all'
# lat,lon,var = read_SPEAR_MED_LM42p2(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper)
