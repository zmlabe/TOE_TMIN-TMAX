...
plt.plot(obs_mean,linestyle='-',linewidth=2,marker='o',markersize=5,
         color='crimson',label=r'\textbf{NClimGrid}',clip_on=False)
plt.plot(model_mean,linestyle='-',linewidth=2,marker='o',markersize=5,
         color='aqua',label=r'\textbf{SPEAR_MED}',clip_on=False)
         

leg = plt.legend(shadow=False,fontsize=13.5,loc='upper center',
...
plt.ylabel(r'\textbf{%s [$\bf{^\circ}$C]}' % variq,fontsize=11,
                      color='w')
plt.title(r'\textbf{MEAN CONUS SEASONAL CYCLE -- 1921-2022}',
                    color='w',fontsize=12)
...
plt.ylabel(r'\textbf{%s [$\bf{^\circ}$C]}' % variq,fontsize=11,
                      color='w')
plt.title(r'\textbf{SPEAR_MED minus NClimGrid -- 1921-2022}',
                    color='w',fontsize=12)
plt.tight_layout()        
