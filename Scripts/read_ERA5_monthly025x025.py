...
Usage
-----
    [1] read_ERA5_monthly025x025(variq,directory,sliceperiod,sliceyear,
                  sliceshape,addclimo,slicenan,newon)
"""

def read_ERA5_monthly025x025(variq,directory,sliceperiod,sliceyear,sliceshape,addclimo,slicenan):
    """
    ...
    print('>>>>>>>>>> ENDING read_ERA5_monthly025x025 function for -- %s!' % variq)
...
# slicenan = 'nan'
# addclimo = True
# lat,lon,var = read_ERA5_monthly025x025(variq,directory,sliceperiod,
