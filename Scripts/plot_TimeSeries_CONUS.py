...
for i in range(len(slicemonthn)):
    ...
    plt.fill_between(x=yearsmodels,y1=spear_minens_max,y2=spear_maxens_max,facecolor='maroon',zorder=0,
             alpha=0.4,edgecolor='none')
    
    # plt.plot(yearsmodels,spear_natural_meanens_max,linestyle='-',linewidth=2,color='teal',
    #          label=r'\textbf{SPEAR-MED-NATURAL}')
    plt.plot(yearsmodels,spear_meanens_max,linestyle='-',linewidth=2,color='maroon',
    ...
    ### Save figure
    plt.savefig(directoryfigure+'%s_T-CONUS_1921-2021.png' % slicemonth,dpi=1000)
