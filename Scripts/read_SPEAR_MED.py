...
def read_SPEAR_MED(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns,timeper):
    ...
    for i,ensmember in enumerate(ens):
        ...
        print('Completed: read *SPEAR_MED historical* Ensemble Member --%s-- for %s' % (ensmember,vari))
    ...
    for i,ensmember in enumerate(ens):
        ...
        print('Completed: read *SPEAR_MED SSP585* Ensemble Member --%s-- for %s' % (ensmember,vari))
