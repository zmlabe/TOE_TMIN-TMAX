...
for mm in range(len(monthlychoiceq)):
    ...
    cmap = cmr.fusion_r
    label = r'\textbf{Relevance [L$_{2}$=0.0; MAE$_{1921-2100}$ = 4.0 years]}'
    ...
    plt.savefig(directoryfigure + 'PredictTheYear_LRPcomparison-%s_AllMethods_%s_%s_%s_NoRidgeParameter.png' % (dataset,variq,monthlychoice,reg_name),dpi=300)
