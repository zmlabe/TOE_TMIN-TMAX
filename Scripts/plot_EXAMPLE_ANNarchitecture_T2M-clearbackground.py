...
# m.drawstates(color='w',linewidth=1)
# m.drawcountries(color='w',linewidth=0.5)

circle = m.drawmapboundary(fill_color=None,color=None,
                  linewidth=0.7)
...
plt.tight_layout()
plt.savefig(directoryfigure + 'Map_ArchitectureExample_TREFHT_1-clearbackground.png',dpi=1000,
            transparent=True)
