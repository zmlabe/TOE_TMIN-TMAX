...
slicemonthnamen = ['JAN-MAR','APR-JUN','JUL-SEP','OCT-DEC','Annual','JUN-AUG']
slicenan = 'nan'
...
for i in range(len(slicemonthn)):
    ...
    # spear_natural_meanens_max = np.nanmean(natural_max,axis=0)
    # spear_natural_maxens_max = np.nanmax(natural_max,axis=0)
    # spear_natural_minens_max = np.nanmin(natural_max,axis=0)
    ###############################################################################
    ###############################################################################
    ############################################################################### 
    ...
    # spear_natural_meanens_min = np.nanmean(natural_min,axis=0)
    # spear_natural_maxens_min = np.nanmax(natural_min,axis=0)
    # spear_natural_minens_min = np.nanmin(natural_min,axis=0)
    ###############################################################################
    ###############################################################################
    ############################################################################### 
    ...
    # plt.fill_between(x=yearsmodels,y1=spear_natural_minens_max,y2=spear_natural_maxens_max,facecolor='teal',zorder=0,
    #          alpha=0.4,edgecolor='none')
    plt.fill_between(x=yearsmodels,y1=spear_minens_max,y2=spear_maxens_max,facecolor='crimson',zorder=0,
             alpha=0.4,edgecolor='none')
    
    # plt.plot(yearsmodels,spear_natural_meanens_max,linestyle='-',linewidth=2,color='teal',
    #          label=r'\textbf{SPEAR-MED-NATURAL}')
    plt.plot(yearsmodels,spear_meanens_max,linestyle='-',linewidth=2,color='crimson',
             label=r'\textbf{SPEAR-MED-SSP5-8.5}')
    
    plt.plot(years,obs_max,linestyle='--',linewidth=2,color='w',
    ...
    # plt.fill_between(x=yearsmodels,y1=spear_natural_minens_min,y2=spear_natural_maxens_min,facecolor='teal',zorder=0,
    #          alpha=0.4,edgecolor='none')
    plt.fill_between(x=yearsmodels,y1=spear_minens_min,y2=spear_maxens_min,facecolor='crimson',zorder=0,
             alpha=0.4,edgecolor='none')
    
    # plt.plot(yearsmodels,spear_natural_meanens_min,linestyle='-',linewidth=2,color='teal',
    #          label=r'\textbf{SPEAR-MED-NATURAL}')
    plt.plot(yearsmodels,spear_meanens_min,linestyle='-',linewidth=2,color='crimson',
             label=r'\textbf{SPEAR-MED-SSP5-8.5}')
    
    plt.plot(years,obs_min,linestyle='--',linewidth=2,color='w',
             dashes=(1,0.5),clip_on=False,zorder=30,label=r'\textbf{NClimGrid}')
    ...
    #          alpha=0.4,edgecolor='none')
    plt.fill_between(x=yearsmodels,y1=spear_minens_avg,y2=spear_maxens_avg,facecolor='crimson',zorder=0,
             alpha=0.4,edgecolor='none')
    
    # plt.plot(yearsmodels,spear_natural_meanens_avg,linestyle='-',linewidth=2,color='teal',
    #          label=r'\textbf{SPEAR-MED-NATURAL}')
    plt.plot(yearsmodels,spear_meanens_avg,linestyle='-',linewidth=2,color='crimson',
             label=r'\textbf{SPEAR-MED-SSP5-8.5}')
    
    plt.plot(years,obs_avg,linestyle='--',linewidth=2,color='w',
             dashes=(1,0.5),clip_on=False,zorder=30,label=r'\textbf{NClimGrid}')
    ...
    ### Save figure
    plt.savefig(directoryfigure+'%s_T-CONUS_1921-2021.png' % slicemonth,dpi=300)
