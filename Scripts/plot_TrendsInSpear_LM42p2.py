"""
Calculate trend for different SPEAR_MED periods to compare with SPEAR_MED_LM42p2
...
directoryfigure = '/home/Zachary.Labe/Research/TOE_TMIN-TMAX/Figures/LMexp' 

### Parameters
monthq = ['JAN','FEB','MAR','ARP','MAY','JUN','JUL','AUG','SEP','OCT','NOV','DEC']
letters = ["a","b","c","d","e","f","g","h","i","j","k","l","m","n"]
variables = ['T2M','EVAP','ALBEDO','PRECT']
slicenan = 'nan'
reg_name = 'US'
...
for s in range(len(variables)):
    ...
    for m in range(len(monthlychoiceq)):
        ...
        years_lmexp = np.arange(1921,2100+1,1)
        ...
        lmexpn,lats,lons = read_primary_dataset(variq,'SPEAR_MED_LM42p2',monthlychoice,scenario,lat_bounds,lon_bounds)
