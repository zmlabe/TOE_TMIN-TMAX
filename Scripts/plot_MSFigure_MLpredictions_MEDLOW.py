...
reg_nameall = ['US','US','US','W_US','Ce_US','E_US']
regionnames = ['CONUS','CONUS','CONUS','WESTERN USA','CENTRAL USA','EASTERN USA']
...
for lll in range(len(datasetsingleall)):
    ...
    plt.text(2100,1952,r'\textbf{%s}' % regionnames[lll],fontsize=13,color='k',ha='right',va='center')
...
plt.tight_layout()
plt.savefig(directoryfigure + 'SPEAR_MED_prediction_MEDLOW.png',dpi=600)  
