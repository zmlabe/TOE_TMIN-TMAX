"""
LRP for LENS2 epochs to see if the regions change
...
for mm in range(len(monthlychoiceq)):
    ...
    label = r'\textbf{%s-%s -- LRP-LENS2 [Relevance]}' % (monthlychoice,variq)
    ...
    plt.savefig(directoryfigure + 'PredictTheYear_LRPcomparison-LENS2_%s_%s.png' % (variq,monthlychoice),dpi=300)
