...
plt.text(-0.4,-1.4,r'\textbf{%s}' % labels[0],fontsize=11,color='w',
          ha='left',va='center')
plt.text(0.55,-1.4,r'\textbf{%s}' % labels[1],fontsize=11,color='w',
          ha='left',va='center')
plt.text(1.7,-1.4,r'\textbf{%s}' % labels[2],fontsize=11,color='w',
          ha='left',va='center')
plt.text(2.7,-1.4,r'\textbf{%s}' % labels[3],fontsize=11,color='w',
          ha='left',va='center')
plt.text(3.7,-1.4,r'\textbf{%s}' % labels[4],fontsize=11,color='w',
          ha='left',va='center')
...
plt.tight_layout()
plt.savefig(directoryfigure + 'validationMAE-%s_BestANNModel_%s_%s_%s_CompareModels-LOWS.png' % (maetype,variq,months,region),dpi=300)
