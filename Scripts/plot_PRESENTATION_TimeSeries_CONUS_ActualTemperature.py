...
for i in range(len(slicemonthn)):
    ...
    plt.fill_between(x=years,y1=spear_minens_max,y2=spear_maxens_max,facecolor='crimson',zorder=0,
             alpha=0.4,edgecolor='none')
    plt.plot(years,spear_meanens_max,linestyle='-',linewidth=2,color='crimson',
    ...
    plt.fill_between(x=years,y1=spear_minens_min,y2=spear_maxens_min,facecolor='crimson',zorder=0,
             alpha=0.4,edgecolor='none')
    plt.plot(years,spear_meanens_min,linestyle='-',linewidth=2,color='crimson',
             label=r'\textbf{SPEAR-MED-SSP5-8.5}')
    ...
    plt.fill_between(x=years,y1=spear_minens_avg,y2=spear_maxens_avg,facecolor='crimson',zorder=0,
             alpha=0.4,edgecolor='none')
    plt.plot(years,spear_meanens_avg,linestyle='-',linewidth=2,color='crimson',
             label=r'\textbf{SPEAR-MED-SSP5-8.5}')
    ...
    ### Save figure
    plt.savefig(directoryfigure+'%s_T-CONUS_1921-2021_ActualTemperature.png' % slicemonth,dpi=300)
