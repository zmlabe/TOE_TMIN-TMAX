...
plt.plot(model_mean,linestyle='-',linewidth=2,marker='o',markersize=5,
         color='teal',label=r'\textbf{FLOR}',clip_on=False)
...
plt.ylabel(r'\textbf{%s [$\bf{^\circ}$C]}' % variq,fontsize=11,
                      color='dimgrey')
plt.title(r'\textbf{FLOR minus NClimGrid -- 1921-2021}',
                    color='k',fontsize=12)
plt.tight_layout()        

### Save figure
plt.savefig(directoryfigure+'SeasonalCycleDifferences_CONUS_%s_FLOR.png' % variq,dpi=300)
