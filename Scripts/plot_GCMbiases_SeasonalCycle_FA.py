"""
Plot biases for SPEAR_MED_FA over CONUS
...
directoryfigure = '/home/Zachary.Labe/Research/TOE_TMIN-TMAX/Figures/Bias/FA/' 
...
plt.plot(model_mean,linestyle='-',linewidth=2,marker='o',markersize=5,
         color='teal',label=r'\textbf{SPEAR_MED_FA}',clip_on=False)
...
plt.ylabel(r'\textbf{%s [$\bf{^\circ}$C]}' % variq,fontsize=11,
                      color='dimgrey')
plt.title(r'\textbf{SPEAR_MED_FA minus NClimGrid -- 1921-2021}',
                    color='k',fontsize=12)
plt.tight_layout()        

### Save figure
plt.savefig(directoryfigure+'SeasonalCycleDifferences_CONUS_%s_FA.png' % variq,dpi=300)
