"""
Calculate climatologies for different spear runs and LM42p2 (differences)
...
modelsnamen = ['SPEAR_MED','SPEAR_MED_LM42p2','SPEAR_MED_FA','a minus b']
scenario = 'SSP585'
...
def readModel(variq,monthlychoice,scenario,lat_bounds,lon_bounds):
    ...
    ### Calculate difference with land model
    diffn = data_spearn - data_spearlmn
    
    return data_spearn,data_spearlmn,data_FAn,diffn,lats,lons

data_spearn_1,data_spearlmn_1,data_FAn_1,data_diffn_1,lats,lons = readModel(variq,monthlychoiceq[0],scenario,lat_bounds,lon_bounds)
data_spearn_2,data_spearlmn_2,data_FAn_2,data_diffn_2,lats,lons = readModel(variq,monthlychoiceq[1],scenario,lat_bounds,lon_bounds)
data_spearn_3,data_spearlmn_3,data_FAn_3,data_diffn_3,lats,lons = readModel(variq,monthlychoiceq[2],scenario,lat_bounds,lon_bounds)
data_spearn_4,data_spearlmn_4,data_FAn_4,data_diffn_4,lats,lons = readModel(variq,monthlychoiceq[3],scenario,lat_bounds,lon_bounds)

dataplot = [data_spearn_1,data_spearlmn_1,data_FAn_1,data_diffn_1,
            data_spearn_2,data_spearlmn_2,data_FAn_2,data_diffn_2,
            data_spearn_3,data_spearlmn_3,data_FAn_3,data_diffn_3,
            data_spearn_4,data_spearlmn_4,data_FAn_4,data_diffn_4]
latsall = [lats,lats,lats,lats,
            lats,lats,lats,lats,
            lats,lats,lats,lats,
            lats,lats,lats,lats]
lonsall = [lons,lons,lons,lons,
            lons,lons,lons,lons,
            lons,lons,lons,lons,
            lons,lons,lons,lons]
...
plt.savefig(directoryfigure + 'Bias_AllGFDLModels-LM42p2_USA_%s-%s_Seasons_Difference.png' % (variq,dataset_obs),dpi=300)
...
plt.savefig(directoryfigure + 'Bias_AllGFDLModels-LM42p2_Global_%s-%s_Seasons_Difference.png' % (variq,dataset_obs),dpi=300)
