...
resolution = 'MEDS'
datasetsingleall = ['SPEAR_MED_ScenarioSSP119','SPEAR_MED_Scenario','SPEAR_MED']
datasetnamelist = ['SPEAR_MED_SSP119','SPEAR_MED_SSP245','SPEAR_MED_SSP585']
...
plt.tight_layout()
plt.savefig(directoryfigure + 'SPEAR_MED_prediction_ScenarioSSP.png',dpi=600)  
